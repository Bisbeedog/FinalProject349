...
export default function FirstPost() {
  ...
  <div className="w-100">  <h1 className = "text-center text-5xl font-semibold">Titan War! </h1>
  <br></br>
  <br></br>
  <br></br>
  <br></br>
  ...
  <p className="m-0 max-w-[30ch] text-l opacity-75  ">
    Titan War is a 2d side scrolling plateformer game made in the style of the old Castlevania and Metroid series. 
    Coded in Unity as a passion project. 
    Development occured between January 2024 and May 2024.
  </p>
